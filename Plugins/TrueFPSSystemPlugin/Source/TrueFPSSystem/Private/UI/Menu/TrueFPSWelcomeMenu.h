...
class FTrueFPSWelcomeMenu : public TSharedFromThis<FTrueFPSWelcomeMenu>
{
public:
	/** build menu */
	void Construct( TWeakObjectPtr< class UTrueFPSGameInstance > InGameInstance );
	...
	TWeakObjectPtr< class UTrueFPSGameInstance > GetGameInstance() { return GameInstance; }

private:
	/** Owning game instance */
	TWeakObjectPtr< class UTrueFPSGameInstance > GameInstance;
