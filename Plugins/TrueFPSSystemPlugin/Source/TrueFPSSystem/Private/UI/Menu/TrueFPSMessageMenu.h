...
class FTrueFPSMessageMenu : public TSharedFromThis<FTrueFPSMessageMenu>
{
public:
	/** build menu */
	void Construct(TWeakObjectPtr<UTrueFPSGameInstance> InGameInstance, TWeakObjectPtr<ULocalPlayer> InPlayerOwner, const FText& Message, const FText& OKButtonText, const FText& CancelButtonText,  const FName& InPendingNextState);
...
private:
	...
	/** Local player that will have focus of the dialog box (can be nullptr) */
