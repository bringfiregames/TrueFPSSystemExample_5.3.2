...
class FTrueFPSRecentlyMet : public TSharedFromThis<FTrueFPSRecentlyMet>
{
public:
	...
	TSharedPtr<FTrueFPSMenuItem> RecentlyMetItem;

	/** holds Recently Met menu item */
	TSharedPtr<FTrueFPSMenuItem> RecentlyMetRoot;
...
protected:
	...
	const struct FTrueFPSOptionsStyle *RecentlyMetStyle;
};