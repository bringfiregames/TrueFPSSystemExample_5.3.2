...
class STrueFPSConfirmationDialog : public SCompoundWidget
{
public:
	...
	ETrueFPSDialogType::Type DialogType;

	SLATE_BEGIN_ARGS( STrueFPSConfirmationDialog )
	{}

	SLATE_ARGUMENT(TWeakObjectPtr<ULocalPlayer>, PlayerOwner)
	SLATE_ARGUMENT(ETrueFPSDialogType::Type, DialogType)
