...
#include "TrueFPSGameSession.generated.h"

struct FTrueFPSGameSessionParams
{
...
UCLASS(config=Game)
class TRUEFPSSYSTEM_API ATrueFPSGameSession : public AGameSession
{
	GENERATED_BODY()

public:
	
	ATrueFPSGameSession(const FObjectInitializer& ObjectInitializer);
...
protected:
	...
	FTrueFPSGameSessionParams CurrentSessionParams;
	/** Current host settings */
	TSharedPtr<class FTrueFPSOnlineSessionSettings> HostSettings;
	/** Current search settings */
	TSharedPtr<class FTrueFPSOnlineSearchSettings> SearchSettings;
	 ...
	 */
	DECLARE_EVENT_TwoParams(ATrueFPSGameSession, FOnCreatePresenceSessionComplete, FName /*SessionName*/, bool /*bWasSuccessful*/);
	...
	DECLARE_EVENT_OneParam(ATrueFPSGameSession, FOnJoinSessionComplete, EOnJoinSessionCompleteResult::Type /*Result*/);
	FOnJoinSessionComplete JoinSessionCompleteEvent;

	/*
	 * Event triggered after session search completes
	 */
	//DECLARE_EVENT(ATrueFPSGameSession, FOnFindSessionsComplete);
	DECLARE_EVENT_OneParam(ATrueFPSGameSession, FOnFindSessionsComplete, bool /*bWasSuccessful*/);
