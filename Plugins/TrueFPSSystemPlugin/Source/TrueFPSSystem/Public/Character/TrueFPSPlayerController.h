...
#include "TrueFPSPlayerController.generated.h"

/**
 * 
 */
UCLASS()
class TRUEFPSSYSTEM_API ATrueFPSPlayerController : public APlayerController
{
	GENERATED_BODY()

public:

	ATrueFPSPlayerController(const FObjectInitializer& ObjectInitializer);
...
// 	virtual void Emote(const FString& Msg);
	...
	void OnDeathMessage(class ATrueFPSPlayerState* KillerPlayerState, class ATrueFPSPlayerState* KilledPlayerState, const UDamageType* KillerDamageType);
	...
	// begin ATrueFPSPlayerController-specific
	...
	/** Returns a pointer to the TrueFPS game hud. May return nullptr. */
	class ATrueFPSHUD* GetTrueFPSHUD() const;
	...
	// end ATrueFPSPlayerController-specific
...
protected:
	...
	/** TrueFPS in-game menu */
	TSharedPtr<class FTrueFPSIngameMenu> TrueFPSIngameMenu;
...
public:
	...
	float TrueFPSFriendUpdateTimer;
