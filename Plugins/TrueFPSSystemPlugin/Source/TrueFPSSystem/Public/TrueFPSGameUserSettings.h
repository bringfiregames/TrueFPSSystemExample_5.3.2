...
#include "TrueFPSGameUserSettings.generated.h"

/**
 * 
 */
UCLASS()
class TRUEFPSSYSTEM_API UTrueFPSGameUserSettings : public UGameUserSettings
{
	GENERATED_BODY()
	
public:

UTrueFPSGameUserSettings(const FObjectInitializer& ObjectInitializer);
...
private:
	...
	/** Enable if UTrueFPSSystemUserSettings is not the authority on resolution */
	UPROPERTY(config)
