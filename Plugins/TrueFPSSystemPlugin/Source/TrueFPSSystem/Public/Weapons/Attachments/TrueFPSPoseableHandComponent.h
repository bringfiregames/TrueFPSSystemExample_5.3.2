...
#include "TrueFPSPoseableHandComponent.generated.h"
...
class TRUEFPSSYSTEM_API UTrueFPSPoseableHandComponent : public USceneComponent
{
	GENERATED_BODY()

public:

	UTrueFPSPoseableHandComponent();
	...
	const FORCEINLINE FPoseSnapshot& GetCachedPoseSnapshot() const
	{
		...
		return UTrueFPSFunctionLibrary::EmptyPose;
	}
...
protected:
	...
	UPROPERTY(EditAnywhere, Category = "Visualization")
	FTransform VisualizationTransform = FTransform(FRotator(90.f, 0.f, 90.f));
