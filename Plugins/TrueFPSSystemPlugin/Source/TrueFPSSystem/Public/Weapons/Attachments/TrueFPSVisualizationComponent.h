...
#include "TrueFPSVisualizationComponent.generated.h"
...
class TRUEFPSSYSTEM_API UTrueFPSVisualizationComponent : public USceneComponent
{
	GENERATED_BODY()

public:
	
	UTrueFPSVisualizationComponent();
